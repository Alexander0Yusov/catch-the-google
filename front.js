...
const moveByKeys = async (code) => {
    ...
    if (code === "ArrowUp")
        await game.movePlayer1Up();
    if (code === "ArrowDown")
        await game.movePlayer1Down();
    if (code === "ArrowLeft")
        await game.movePlayer1Left();
    if (code === "ArrowRight")
        await game.movePlayer1Right();
    // WASD всегда двигают Player 2.
    if (code === "KeyW")
        await game.movePlayer2Up();
    if (code === "KeyS")
        await game.movePlayer2Down();
    if (code === "KeyA")
        await game.movePlayer2Left();
    if (code === "KeyD")
        await game.movePlayer2Right();
};
